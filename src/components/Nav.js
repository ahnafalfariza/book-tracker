...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      {showMobileNav && (
        <Modal close={(_) => setShowMobileNav(false)}>
          <div className="h-full w-full text-center bg-dark-primary-800 bg-opacity-75 relative">
            <div className="absolute top-0 left-0 p-4 h-20 flex items-center">
              <svg
                onClick={(_) => setShowMobileNav(false)}
                width="32"
                height="32"
                viewBox="0 0 16 16"
                fill="none"
            ...
            <div className="mt-24">
              <div>
                <div className="w-56 mx-auto p-4">
                ...
                <div className="mt-4">
                  <NavLink
                    className="text-3xl text-gray-300 opacity-50 font-medium"
      ...
      <div className="max-w-5xl m-auto p-4">
        <div className="w-full flex items-center justify-between">
          <div className="w-1/2 md:w-1/4 flex items-center">
            {userId && (
              <div className="block md:hidden mr-2" onClick={(_) => setShowMobileNav(true)}>
                <svg width="32" height="32" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M2 3V5H14V3H2ZM2 9V7H14V9H2ZM2 13V11H14V13H2Z"
                    fill="white"
                  />
                </svg>
              </div>
            )}
            <div className="md:pl-0 w-24">
              <Link to="/">
                <svg
